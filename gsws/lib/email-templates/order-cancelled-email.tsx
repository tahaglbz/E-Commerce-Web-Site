    ...
    <div style="background: #09090b; padding: 40px 20px;">
      <div style="max-width: 600px; margin: 0 auto; background: #18181b; border: 1px solid #27272a; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5);">
        ...
        <div style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 30px 20px; text-align: center;">
          <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 700;">⚠️ Siparişiniz İptal Edildi</h1>
        </div>

        <!-- Content -->
        <div style="padding: 30px 25px;">
          <p style="margin: 0 0 25px 0; color: #d4d4d8; font-size: 14px; line-height: 1.6;">Merhaba <strong>${customerName}</strong>,</p>

          <p style="margin: 0 0 20px 0; color: #a1a1a6; font-size: 14px; line-height: 1.6;">
            Siparişiniz başarıyla iptal edilmiş olup, ödemeniz güvenle iade sürecine alınmıştır.
          </p>

          <!-- Sipariş Bilgileri Card -->
          <div style="background: #27272a; border-left: 4px solid #ef4444; padding: 20px; border-radius: 8px; margin: 25px 0;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin: 12px 0; padding: 8px 0; border-bottom: 1px solid #3f3f46;">
              ...
              <span style="color: #ef4444; font-weight: 600; font-size: 13px;">#${orderId}</span>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin: 12px 0; padding: 8px 0; border-bottom: 1px solid #3f3f46;">
              ...
              <span style="color: #ec4899; font-weight: 700; font-size: 14px;">₺${totalPrice.toFixed(2)}</span>
            </div>

            <div style="display: flex; justify-content: space-between; align-items: center; margin: 12px 0; padding: 8px 0;">
              <span style="color: #a1a1a6; font-size: 13px;">İptal Tarihi:</span>
              <span style="color: #d4d4d8; font-weight: 500; font-size: 13px;">${new Date(cancelledAt).toLocaleDateString('tr-TR', {
                year: 'numeric',
                month: 'long',
                day: 'numeric',
                hour: '2-digit',
          ...
          <div style="background: #1f2937; border-left: 4px solid #10b981; padding: 15px; border-radius: 8px; margin: 20px 0;">
            <p style="margin: 0; color: #10b981; font-size: 13px; font-weight: 600;">✅ İade Süreci</p>
            <p style="margin: 8px 0 0 0; color: #d4d4d8; font-size: 13px; line-height: 1.5;">
              Siparişiniz iptal edildiğinden, ödenmiş olan miktar 5-10 iş günü içinde orijinal ödeme yönteminize iade edilecektir.
            </p>
          </div>
          ...
          <div style="background: #27272a; padding: 15px; border-radius: 8px; margin: 20px 0;">
            <p style="margin: 0; color: #a1a1a6; font-size: 13px; line-height: 1.5;">
              Sorularınız varsa veya iptal işleminde sorun yaşıyorsanız,
              <a href="mailto:tahaglbz1@gmail.com" style="color: #ec4899; text-decoration: none; font-weight: 600;">iletişim formu</a> aracılığıyla bize ulaşabilirsiniz.
            </p>
          </div>

          <!-- CTA Button -->
          <div style="margin: 30px 0; text-align: center;">
            <a href="https://tcgiftshop.com/orders" style="display: inline-block; background: linear-gradient(135deg, #ec4899 0%, #a855f7 100%); color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">📋 Siparişlerinizi Görüntüle</a>
          </div>
        </div>

        <!-- Footer -->
        <div style="background: #27272a; padding: 20px; text-align: center; border-top: 1px solid #3f3f46;">
          <p style="margin: 0; color: #71717a; font-size: 12px;">TC Gift Shop - Müşteri İlişkileri</p>
